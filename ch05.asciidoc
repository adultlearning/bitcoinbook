...
<!-- type 0 is not generated, just keys -->
...
<!-- oh hell yeah. so instead of remembering a giant amount of private public key pairs, all you need to remember is the mnemonic (and possible password) to derive all of the entries. but all the server needs is the pub key one -->
