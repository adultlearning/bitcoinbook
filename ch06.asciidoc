...
ok so 60e3160000000000 is 8 bytes (4*16 bits) (and the 0s at end indicate little endian number)
length is from
19 to 1976a914ab68025513
guessing 1976a914 since it repeats
which is
19 76 a9 14 that being 00011001 01110110 10101001 00010100 that being (big endian) 25 

hint says 25 or 0x19
...
<!-- CUZ THE BITCOIN ADDRESS IS GENERATED BY THE PUBLIX KEY HASH!!-->
